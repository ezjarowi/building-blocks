...
export const LOOKS: {
  ...
  { id: "paper", name: "Paper", vibe: "Warm, quiet, like a notebook" },
...
export const LOOK_BOOT = `(function(){try{var t=localStorage.getItem("${LOOK_KEY}")||"paper";var n=localStorage.getItem("${NIGHT_KEY}")==="1";document.documentElement.setAttribute("data-theme",t);document.documentElement.classList.toggle("dark",n);}catch(e){}})();`;
